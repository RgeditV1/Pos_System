...
class Ui_main(object):
    ...
    def retranslateUi(self, main):
        ...
        self.total_nro.setText(QCoreApplication.translate("main", u"<html><head/><body><p><span style=\" font-weight:700;\">0.0</span></p></body></html>", None))
        self.itbis_nro.setText(QCoreApplication.translate("main", u"<html><head/><body><p><span style=\" font-weight:700;\">0.0</span></p></body></html>", None))
        ...
        self.sub_nro.setText(QCoreApplication.translate("main", u"<html><head/><body><p><span style=\" font-weight:700;\">0.0</span></p></body></html>", None))
